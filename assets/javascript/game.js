...
var hangman = {
    ...
    init: function() {
        ...
        document.querySelector("#hangman-img").src = 'assets/images/main.jpg';
    },
    ...
    winLoseCountAndAudioOnGameEnd: function() {
        if (this.lives === 0) {
            document.querySelector("#hangman-img").src = "assets/images/lost.jpg";
        ...
        if (this.matchedLettersCount == this.computerWordLength) {
            document.querySelector("#hangman-img").src = "assets/images/" + this.computerWord + ".jpg";
